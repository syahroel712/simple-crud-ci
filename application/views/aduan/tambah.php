...
<div class="row">
    ...
    <div class="col-lg-12 mb-12">
        ...
        <div class="card shadow mb-12">
            ...
            <div class="card-body">
                <form name="form1" method="POST" enctype="multipart/form-data" action="<?php echo base_url('add-aduan') ?>">
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label">ISI ADUAN</label>
                        <div class="col-sm-10">
                            <textarea name="aduan_isi" class="ckeditor" id="ckeditor" cols="30" rows="10" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="aduan_foto" required>
                        </div>
                    </div>
                    <div class="form-group row">
