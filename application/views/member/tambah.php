...
<div class="row">
    ...
    <div class="col-lg-12 mb-12">
        ...
        <div class="card shadow mb-12">
            ...
            <div class="card-body">
                <form name="form1" method="POST" enctype="multipart/form-data" action="<?php echo base_url('add-member') ?>">
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">NAMA MEMBER</label>
                        <div class="col-sm-9">
                            <input type="text" name="member_nama" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="member_nik" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" name="member_gender" id="optionsRadios1" class="form-check-input" value="Pria" checked />Pria
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="radio" name="member_gender" id="optionsRadios2" class="form-check-input" value="Wanita" />Wanita
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="member_notelp" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">BIO MEMBER</label>
                        <div class="col-sm-9">
                            <input type="text" name="member_bio" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">ALAMAT MEMBER</label>
                        <div class="col-sm-9">
                            <input type="text" name="member_alamat" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">KOORDINAT MEMBER</label>
                        <div class="col-sm-9">
                            <input type="text" name="member_koordinat" required class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
