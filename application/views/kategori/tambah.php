...
<div class="row">
    ...
    <div class="col-lg-12 mb-12">
        ...
        <div class="card shadow mb-12">
            ...
            <div class="card-body">
                <form name="form1" method="POST" enctype="multipart/form-data" action="<?php echo base_url('add-kategori') ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="kategori_icon" required>
                        </div>
                    </div>
                    <div class="form-group row">
